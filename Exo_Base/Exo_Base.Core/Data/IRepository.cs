...
namespace Exo_Base.Core.Data
{
    public interface IRepository<TEntity>: IDisposable where TEntity : BaseEntity
    {
        ...
        //List<TEntity> GetAllAsync(Expression<Func<TEntity, int>> keySelector, OrderBy orderBy = OrderBy.Ascending);
        //List<TEntity> GetAllAsync(Expression<Func<TEntity, int>> keySelector, Expression<Func<TEntity, bool>> predicate, OrderBy orderBy, params Expression<Func<TEntity, object>>[] includeProperties);
